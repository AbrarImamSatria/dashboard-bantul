  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h1 className="text-center text-2xl font-bold mb-1">Excecutive Login</h1>
        <p className="text-center text-gray-600 mb-6">Portal Layanan Administrasi Kota Bantul</p>
